    ...
    return (
        <main className="flex-1 h-full w-full overflow-hidden flex">
            <PanelGroup direction="horizontal">
                <Panel defaultSize={50} minSize={20} order={1} className="bg-gray-50 dark:bg-zinc-900 h-full">
                    {whiteboard}
                </Panel>
                ...
                <Panel defaultSize={50} minSize={20} order={2} className="bg-white dark:bg-black h-full">
                    {result}
                </Panel>
            </PanelGroup>
        </main>
